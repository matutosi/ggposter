...
`inst/extdata/README.md` に，対応する acposter・qtposter のファイルを並べた表がある．
...
`inst/extdata/poster_sample_flat.yml` が，この書き方で書いたポスター一式である
...
解析から出てきた図や表を並べるポスターに向く．
3つはヘッダーのキー名と `grid:` の書式を共有し，同じ4本の見本を持つ．
