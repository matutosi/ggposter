...
## List of main functions in ggposter
...
title <- "Functions for combining grobs"
fontsize <- 26
tbl_fun_combine_grobs <- 
...
title <- "Functions for generating table grob"
fontsize <- 26
tbl_tbl_table_grob <- 
  tibble::tibble(name = fun, descrintion = descrintion) %>%
    booktab_table_grob(title = title, fontsize = fontsize) %>%
...
title <- "Functions for converting figure into grob"
fontsize <- 26
tbl_convert <- 
  tibble::tibble(name = fun, descrintion = descrintion) %>%
    booktab_table_grob(title = title, fontsize = fontsize) %>%
...
title <- "Functions for arranging text"
fontsize <- 26
tbl_arrange_text <- 
  tibble::tibble(name = fun, descrintion = descrintion) %>%
    booktab_table_grob(title = title, fontsize = fontsize) %>%
