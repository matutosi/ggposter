...
grid.newpage()
grid.draw(
  (small %oo% tall %oo% wide %oo% large) %8%
  appose_image_grobs(small, tall, wide, large, space=grid::unit(1, "mm"), unify="as_is")
  )
...
original        <- small %oo% tall %oo% wide %oo% large
...
rlogo <- 
  ...
  png::readPNG() %>%
  grid::rasterGrob()
grid::grid.draw(rlogo %oo% rlogo %oo% rlogo)
