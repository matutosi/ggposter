...
image_combined <- stack_image_grobs(fix_width_as_is, fix_width_height, width=half, unify="width", space=space)
...
txt_BODY_43   <- "- Can unify height or width of each image (argument: unify).<br>"
txt_BODY_44   <- "- Can fix hole width and height of combined grob (argument: width, height). <br>"

txt <- str_c(txt_ITEM_40, txt_BODY_41, txt_BODY_42, txt_BODY_43, txt_BODY_44)
grid.draw(gridtext::textbox_grob(txt, use_markdown=FALSE))

image_description <- arrange_txt(
  txt_ITEM_40, 
...
image_and_description <- stack_grobs_conv(image_description, image_combined, gp=gpar(cex=cex))
...
image_and_description <- stack_grobs(image_description, image_description, gp=gpar(cex=cex))
grid::grid.show.layout(image_and_description$frame$layout)
grid.draw(image_and_description)
convertUnit(grobHeight(image_and_description), "mm")
convertUnit(grobWidth(image_and_description),  "mm")

image_and_description <- stack_grobs(image_description, image_description)
grid::grid.show.layout(image_and_description$frame$layout)
grid.draw(image_and_description)
convertUnit(grobHeight(image_and_description), "mm")
convertUnit(grobWidth(image_and_description),  "mm")
