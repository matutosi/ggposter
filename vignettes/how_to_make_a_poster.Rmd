...
While default widths of fig and text is grid::unit(c(60, 240), "mm"), 
...
grid::grid.newpage()
ftg <- appose_fig_text(fig, text, widths = grid::unit(c(80, 160), "mm"), fontsize = 26)
grid::grid.draw(ftg)
```


ggplot2grob <- function(gg, fontsize){
