...
fix_width_height <- 
  combine_grobs(jpg_grobs, direction = "horizontal", width = half, unify = "height", space = space_02)
fix_width_width  <- 
  combine_grobs(jpg_grobs, direction = "horizontal", width = half, unify = "width",  space = space_02)
...
objectives <- arrange_txt(
  txt_ITEM_10, 
  txt_BODY_11, txt_BODY_12, txt_BODY_13, widths=half)

backgrounds <- arrange_txt(
  txt_ITEM_20, 
  txt_BODY_21, txt_BODY_22, txt_BODY_23, widths=half)
  # show layout
...
```{r fig_font_size, opts.label="small"}
fig_font_size <- 
  font_size_list %>%
...
tbls <- 
  combine_grobs(
    tbls_description, tbl_font_size, tlb_base_size, 
...
fix_width_width  <- 
  ...
  # appose_image_grobs(jpg_grob_1, jpg_grob_2, png_grob_1, width=half)
stacked_image_grob <- 
  combine_grobs(fix_width_height, fix_width_width, direction = "vertical", unify = "width",space = space_02)
...
apposed <- combine_grobs(tbl_font_size, tlb_base_size, direction="horizontal", unify="as_is", space = space_02)
grid::grid.draw(apposed)
```
...
apposed_fixed <- combine_grobs(tbl_font_size, tlb_base_size, direction="horizontal", unify="as_is", space = space_02)
