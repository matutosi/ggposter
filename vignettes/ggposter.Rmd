...
grid_spec <- list(
  ...
  sections = list(
    ...
    tall = list(header = "TALL", height = "auto", body = list(type = "text", md = c(
      ...
      "  leaves blank space below instead of growing them."
    ))),
    a = list(header = "A", height = "auto", body = list(type = "text", md = "- One of two side-by-side cards.")),
    b = list(header = "B", height = "auto", body = list(type = "text", md = "- The other side-by-side card.")),
    wide = list(header = "WIDE", height = "auto", body = list(type = "text", md = "- `wide` spans both left columns again, on row 2."))
  )
)
