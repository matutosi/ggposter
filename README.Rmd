...
```{r howto_preview, warning = FALSE, fig.alt = "A tutorial poster titled 'How to Make an Academic Poster', with a left column showing one example of each ggposter card type (bullet list, figure, figure with notes, table, table with a caption, and photo) and a right column showing the R code that built each matching card."}
