...
fix_width_height <- 
  combine_grobs(jpg_grobs, direction = "horizontal", width = half, unify = "height", space = space)
fix_width_width  <- 
  combine_grobs(jpg_grobs, direction = "horizontal", width = half, unify = "width",  space = space)
...
grid::grid.newpage()
combined <- 
  combine_grobs(apposed, stacked, direction = "horizontal", unify = "as_is", space=unit(2, "mm"))
...
grid::grid.draw(combine_grobs(rtg, tbg, direction = "vertical", unify = "as_is", space = space * 10))
```
...
grid::grid.draw(
  combine_grobs(
    ...
    direction="horizontal", unify="as_is", space=grid::unit(20, "mm")))
```
...
apposed <- combine_grobs(tbl_font_size, tlb_base_size, direction="horizontal", unify="as_is", space=space)
grid::grid.draw(apposed)
```
...
apposed_fixed <- combine_grobs(tbl_font_size, tlb_base_size, direction="horizontal", unify="as_is", space=space)
