...
You can also use parts of a poster for other slides and other presentation parts, and vice versa. 
...
If you do not specify `base_size` in particular, `base_size` of 26 pt will be used.
You can select 8, 10, 12, 14, 18, 22, 26, 32, and 38 pt as a `base_size`. 
I recommend you to use 22, 26 or 32 pt for a poster in a general use. 
...
As descrived above, you can choose specify `base_size` or omit it. 
...
```{r font_size_example, fig.width=8.3, out.width="100%", fig.height=4}
...
You can see font size as plot by ggplot2 visualisation as below. 
...
If you can chage values of `size`, `base_size`, and others by overwriting `font_size_list`. ???
...
You can make a table grob using `tableGrob()` in gridExtra, and draw it. 
...
When you want make a table like booktab in LaTeX or in a academic journal, 
...
You can change appearance of table grob by customizing gridExtra::tableGrob(). 
